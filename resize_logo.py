...
old_tag = '<img src="/06-imagens/Conexxus-digital-marketing-logo-transparent.png" alt="Conexxus Logo" class="h-10 w-auto">'
...
print(f"Increased logo size in {count} files.")
